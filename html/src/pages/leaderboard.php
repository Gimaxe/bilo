  ...
  background-color: #0056b3; /* Couleur de fond au survol */
            ...
            <?php
                ...
                if (isset($_SESSION["pseudo"])) {
                    echo "<p id='bienvenue'>Bienvenue " . $_SESSION["pseudo"] . " !</p>";
                } else {
                    echo "<p id ='bienvenue'>Vous n'êtes pas connecté.</p>";
                }
            ?>          
...
<div class="flex flex-col items-center justify-center h-4/5 ">
    ...
    <script>
        ...
        function chargerTable() {
            fetch("../../backend/show_dashboard.php")
                ...
                .then(data => {
                    ...
                    data.forEach(row => {
                        ...
                        tr.innerHTML = `<td>${row.user_pseudo}</td><td>${row.nbr_click}</td>`;
        ...
        function chargerTable() {
            ...
            data.forEach(row => {
                const tr = document.createElement('tr');
                tr.innerHTML = `<td>${row.user_pseudo}</td><td class="border-l pl-4">${row.nbr_click}</td>`;
                table.appendChild(tr);
            });
        })
        .catch(error => console.error(error));
